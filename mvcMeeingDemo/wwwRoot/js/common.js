...
function setBtnClickFuc() {
    ...
    $('#video-btn').on('click', () => {
        if (isCamOn) {
            $('#video-btn').attr('src', '/imgs/big-camera-off.png');
            $('#member-me')
                .find('.member-video-btn')
                .attr('src', '/imgs/camera-off.png');
            isCamOn = false;
            muteVideo();
        } else {
            $('#video-btn').attr('src', '/imgs/big-camera-on.png');
            $('#member-me')
                .find('.member-video-btn')
                .attr('src', '/imgs/camera-on.png');
            isCamOn = true;
            unmuteVideo();
        }
    });
    ...
    $('#mic-btn').on('click', () => {
        if (isMicOn) {
            $('#mic-btn').attr('src', '/imgs/big-mic-off.png');
            $('#member-me')
                .find('.member-audio-btn')
                .attr('src', '/imgs/mic-off.png');
            isMicOn = false;
            muteAudio();
        } else {
            $('#mic-btn').attr('src', '/imgs/big-mic-on.png');
            $('#member-me')
                .find('.member-audio-btn')
                .attr('src', '/imgs/mic-on.png');
            isMicOn = true;
            unmuteAudio();
        }
    });
    ...
    $('#screen-btn').on(
        ...
        throttle(() => {
            ...
            if ($('#screen-btn').attr('src') == '/imgs/screen-on.png') {
                $('#screen-btn').attr('src', '/imgs/screen-off.png');
                stopSharing();
                isScreenOn = false;
            } else {
                $('#screen-btn').attr('src', '/imgs/screen-on.png');
                startSharing();
                isScreenOn = true;
            }
        }, 2000)
    ...
    $('#camera').on('show.bs.popover', () => {
        $('#camera').attr('src', '/imgs/camera-popover.png');
    });
    $('#camera').on('hide.bs.popover', () => {
        $('#camera').attr('src', '/imgs/camera.png');
    });

    $('#microphone').on('show.bs.popover', () => {
        $('#microphone').attr('src', '/imgs/mic-popover.png');
    });
    $('#microphone').on('hide.bs.popover', () => {
        $('#microphone').attr('src', '/imgs/mic.png');
    });
}
